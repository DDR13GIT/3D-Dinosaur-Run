...
class BasicWorldDemo {
  constructor() {
    this._Initialize();
    this.thresholdScore = 40;
    this.scoreExceeded = false;
  ...
  _Initialize() {
    ...
    const uniforms = {
      topColor: { value: new THREE.Color(0x0E1F30) },
      bottomColor: { value: new THREE.Color(0x233F66) },
      offset: { value: 33 },
      exponent: { value: 0.6 }
    };
  ...
  //   if (this.player_.score_ > this.thresholdScore && !this.scoreExceeded) {
  //     this.ChangeSkyColor();
  //     this.scoreExceeded = true;
  // }
}
// ChangeSkyColor() {
//   const topColor = new THREE.Color(0x95AF65); // Set your desired top color
//   const bottomColor = new THREE.Color(0x95AF65); // Set your desired bottom color
//   this.background_.ChangeSkyColors(topColor, bottomColor);
// }
}
