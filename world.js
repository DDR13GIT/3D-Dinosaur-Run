...
export const world = (() => {
  ...
  class WorldObject {
    constructor(params) {
      ...
      this.thresholdScore_ = 100; // Set your desired threshold score
      this.scoreExceeded_ = false;
      this.params_ = params;
      this.LoadModel_();
    }
  ...
  class WorldManager {
    ...
    UpdateScore_(timeElapsed) {
      ...
      if (!this.scoreExceeded_ && this.score_ > this.thresholdScore_) {
        this.params_.background.ChangeSkyColors(); // Call the method to change sky color
        this.scoreExceeded_ = true;
      }
    }
